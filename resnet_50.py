...
optimizer = optim.Adam(model.parameters(), lr=0.003, weight_decay=5e-5,amsgrad=True)
scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=5, gamma=0.65)

if __name__=='__main__':
    print("-------------start training!-------------")
    for epoch in range(87):              # Train the model
        running_loss = 0.0
    ...
    torch.save(model, 'resnet50_cifar10.pth')
    print("Model saved.")